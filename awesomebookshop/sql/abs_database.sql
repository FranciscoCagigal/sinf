...
DROP TABLE IF EXISTS ArmazemPublicacao CASCADE
;
...
(
	ArmazemID SERIAL,
	PrimaveraArmazemID varchar(30) NOT NULL,
	Nome varchar(100) NOT NULL,
	CONSTRAINT PK_Armazem PRIMARY KEY (ArmazemID)
)
;

CREATE TABLE ArmazemPublicacao
(
	ArmazemID integer NOT NULL,
	PublicacaoID integer NOT NULL,
	Stock integer NOT NULL,
	CONSTRAINT PK_ArmazemPublicacao PRIMARY KEY (ArmazemID,PublicacaoID)
)
;
...
(
	AutorID SERIAL,
	PaisID integer NOT NULL DEFAULT 193,
	Nome varchar(100) NOT NULL,
	Genero varchar(50),
	Datanascimento date,
	Biografia text NULL,
...
(
	PublicacaoID SERIAL,
	PrimaveraID varchar(10) NOT NULL,
...
ALTER TABLE ArmazemPublicacao ADD CONSTRAINT FK_Armazem_ID
	FOREIGN KEY (ArmazemID) REFERENCES Armazem (ArmazemID)
;

ALTER TABLE ArmazemPublicacao ADD CONSTRAINT FK_Armazem_Publicacao_ID
...
/* ------------------------------------------------------ R1 Publicação ------------------------------------------------------ */
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0001',1,1,'Arte Portuguesa no Século XX','01/01/2017','3230014481474','Bernardo Pinto de Almeida, aquele que muitos consideram o mais importante crítico de arte da actualidade, oferece-nos aqui uma larga visão panorâmica e solidamente fundamentada da recepção nacional aos movimentos artísticos do século XX e dos seus protagonistas. De agora em diante esta obra, ilustrada por centenas de imagens, muitas delas quase inéditas, será «a» História da Arte Portuguesa do Século XX, uma referência incontornável para artistas, coleccionadores, estudiosos e amantes de arte.',496,0.496,59.99,53.91,TRUE,3,'primeira',NULL,'9789898851086',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0002',2,1,'Guia Essencial Para o Estudante de Fotografia Profissional','01/01/2017','2192558647840','Capturar e compartilhar imagens fotográficas são práticas bastante comuns atualmente, que estão ao alcance de todos. No entanto, neste universo digital do século xxi, no qual milhões de pessoas se comunicam todos os dias por meio de fotografias, nem sempre é fácil saber quais conhecimentos um fotógrafo deve reunir para conseguir se distinguir dos demais como profissional.',192,0.192,21.20,19.08,TRUE,11,'primeira',NULL,'9788584520848',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0003',3,2,'SAGA','01/01/2017','5086812095806','Fantasia e ficção científica - e sexo, política, traição, morte, amor verdadeiro e reality shows - juntam-se como nunca antes neste épico subversivo e provocante do escritor Brian K. Vaughan e da artista Fiona Staples.',152,0.152,10.99,9.89,TRUE,10,'primeira',NULL,'9788416510290',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0004',3,2,'Velvet - Vol. 2','01/01/2017','4220053295829','Dos criadores de Capitão América: O Soldado de Inverno, uma das mais brilhantes séries de espionagem em banda desenhada.',128,0.128,9.99,8.99,FALSE,13,'segunda',NULL,'9788416510269',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0005',4,3,'Ciência Cosmológica','01/01/2016','2565704760882','Uma viagem até à moderna ciência do Universo. A ciência, como actividade humana socialmente relevante, é relativamente recente. Contudo, a cosmologia, como visão do Universo ligada a construções mágicas e religiosas, é bem mais antiga.',192,0.192,15.00,15.00,TRUE,12,'primeira',NULL,'9789896167165',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0006',5,3,'O Livro da Ciência','01/01/2017','3205973219926','MAIS UM LIVRO DA COLEÇÃO GRANDES IDEIAS Será que o Universo começou com um Big Bang? A luz é uma onda, uma partícula - ou ambas? Será que somos a causa do aquecimento global? É possível uma Teoria de Tudo?',352,0.352,24.50,22.05,FALSE,4,'primeira',NULL,'9789897542664',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0007',6,4,'Inteligência Multifocal','01/01/2017','5539924172326','Este livro pretende levar o leitor a caminhar para dentro de si mesmo e a expandir o mundo das ideias sobre a mente humana, a construção de pensamentos e a formação de pensadores.',360,0.360,16.60,14.94,FALSE,3,'primeira',NULL,'9789896874056',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0008',7,4,'Amor Zero','01/01/2017','1638761835655','Os psicopatas não têm de ser assassinos, mas estão entre nós e podem matar a nossa autoestima. Conheça os sinais de alerta para não cair no poço sem fundo do amor zero. O amor transforma-se num inferno quando o homem ou a mulher por quem nos apaixonámos deixa cair a máscara e revela-se um psicopata - com zero remorsos, zero empatia, zero compaixão, zero lealdade.',256,0.256,17.90,16.11,TRUE,8,'primeira',NULL,'9789896268060',3);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0009',8,5,'Labirintos Quase Impossíveis','01/01/2017','6444561682733','Elaborado pelo aclamado autor bestseller Gareth Moore, este livro reúne 30 complexos e desafiantes labirintos para resolver. Tem tanto de divertido como de diabólico, mas para os apaixonados por quebra-cabeças, nada lhes trará mais satisfação do que completar os desafios propostos.',84,0.084,11.90,10.71,TRUE,13,'primeira',NULL,'9789898857064',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0010',9,5,'Estética e Desporto','01/01/2017','2586530428762','Lembro-me de quando a rivalidade entre Roger Federer e Rafael Nadal estava no auge ter utilizado uma hipérbole para sublinhar as diferenças essenciais nos duelos entre ambos - o Homem do Renascimento contra o Cro-Magnon.',256,0.256,12.00,10.80,FALSE,3,'primeira',NULL,'9789723615388',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0011',10,6,'Condomínio','01/01/2017','8871263074269','A legislação relativa aos condomínios encontra-se vertida no Código Civil e em vários diplomas avulsos, razão pela qual nem sempre é simples dispor de todo o material de consulta prático e fidedigno nesta área.',192,0.192,12.90,11.61,TRUE,8,'decima',NULL,'978-972-0-02009-3',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0012',10,6,'Códigos Penal e Processo Penal','01/01/2017','3739359213965','É nosso objetivo oferecer aos profissionais do Direito uma seleção dos textos mais relevantes, devidamente consolidados e organizados, tendo em conta as últimas alterações legais.',840,0.840,22.00,19.80,FALSE,4,'oitava',NULL,'978-972-0-00048-4',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0013',11,7,'Programação de CNC para Torno e Fresadora','01/01/2016','2411708370019','Expõe os principais conceitos e a maquinação de peças em várias linguagens. Exercícios propostos e resolvidos para uma autoaprendizagem. Para profissionais, formação profissional e ensino superior.',368,0.368,26.65,23.99,TRUE,5,'primeira',NULL,'9789727228430',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0014',12,7,'Guia de Aplicações de Gestão de Energia e Eficiência Energética','01/01/2016','8478814991251','A energia é um bem que deve ser optimizado a um custo cada vez mais relevante. É importante maximizar a sua produção eficiente e racionalizar o seu consumo.',527,0.527,33.00,33.00,FALSE,11,'terceira',NULL,'9789897231544',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0015',13,8,'Adolescência, os Anos da Mudança','01/01/2016','6323951187888','Viver com um adolescente é um dos maiores desafios para qualquer pai. É estimulante mas também pode ser assustador! Este é o guia ideal para si e para os seus filhos.',352,0.352,16.99,15.29,FALSE,12,'primeira',NULL,'9789898843630',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0016',7,8,'Os Nossos Adolescentes e a Droga','01/01/2016','6740535325490','Num registo a que já nos habituou, Mário Cordeiro fala de um tema sensível, mas o qual é urgente discutir: os adolescentes e a droga.',344,0.344,19.90,17.91,TRUE,3,'primeira',NULL,'9789896267834',4);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0017',14,9,'As Receitas da Minha Querida Mãe','01/01/2017','7079696892385','As Receitas da Minha Querida Mãe é uma obra onde são reveladas as preferências gastronómicas destas madeirenses muito acarinhadas pelos seguidores.',120,0.120,18.00,16.20,FALSE,5,'primeira',NULL,'9789892404844',3);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0018',14,9,'Deixei de Comer Carne. E Agora?','01/01/2017','6735213228700','Tomou a decisão de deixar comer carne e depois de olhar para os produtos, denominados vegetarianos, fica sem saber o que fazer? É mais fácil do que imagina!',128,0.128,16.00,14.40,FALSE,13,'primeira',NULL,'9789892404851',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0019',15,10,'Tenha Um Bom Dia!','01/01/2017','6422249201404','Caroline Webb, economista e antiga partner da consultora McKinsey, mostra aos leitores as mais recentes descobertas no campo da economia comportamental, da psicologia e da neurociência que poderão alterar a sua vida.',392,0.392,18.95,17.06,FALSE,4,'primeira',NULL,'9789722358989',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0020',16,10,'Atitude UAUme!','01/01/2017','9515343926026','O sucesso internacional deste top seller resulta da Atitude UAUme! ser um conceito inovador que explora que todos temos de impactar os outros positivamente através da SURPRESA!',304,0.304,15.99,14.39,FALSE,14,'primeira',NULL,'9789897060526',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0021',17,11,'Os Últimos Dias de Estaline','01/01/2017','6562631901643','Em 2017 celebram-se os 100 anos da Revolução Russa O colapso repentino de Estaline, que o leva à morte, em Março de 1953, foi tão dramático e misterioso como a sua vida.',336,0.336,24.90,22.41,FALSE,6,'primeira',NULL,'9789896651770',3);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0022',18,11,'Grandes Discursos da História','01/01/2017','8381412076092','Foram as palavras que Péricles gritou aos cidadãos de Atenas que fundaram a democracia? Foi o «Ich bin ein Berliner», essa emotiva frase de John Kennedy, que deu à parte livre de Berlim a força de resistir?',208,0.208,16.00,14.40,FALSE,5,'primeira',NULL,'9789897022630',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0023',11,12,'Desenvolvimento em Swift para iOS','01/01/2017','8203137094131','A linguagem Swift é uma linguagem open source com um elevado crescimento e que permite desenvolver aplicações em diversos contextos, nomeadamente aplicações iOS, watchOS, tvOS e OS X.',256,0.256,24.95,22.46,TRUE,14,'primeira',NULL,'9789727228591',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0024',11,12,'Android','01/01/2017','3237163641803','As necessidades diárias dos consumidores continuam fortemente ligadas aos dispositivos móveis, que se tornaram objetos essenciais na vida de qualquer um. Para responder a estas exigências do dia a dia, o desenvolvimento de aplicações para dispositivos Android continua a apresentar um forte crescimento.',192,0.192,19.95,17.96,TRUE,12,'primeira',NULL,'9789727228621',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0025',10,13,'O feitiço de Marraquexe','01/01/2017','5224243915040','No coração da histórica Medina de Marraquexe, entre os animados souks e bazares, encontra-se um grupo de europeus, desfrutando a tranquilidade de um riad.',416,0.416,17.70,15.93,FALSE,6,'primeira',NULL,'978-972-0-04803-5',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0026',19,13,'Para onde vão os gatos quando morrem?','01/01/2017','6972274592095','O regresso a Ataúro, terra da infância, «terra do nunca», é o início desta nova viagem ao revés, de Luís Cardoso, um romance veloz, poético e emotivo, que percorre a infância e a idade de formação do narrador, a diáspora, as lutas, as desilusões, as traições, as perdas, o regresso, cruzando-o com uma plêiade de personagens extraordinárias. Uma viagem que, naturalmente, corre ao lado da história de Timor Leste, com a fantasia e a ironia que marcam desde sempre a voz do autor e nos fazem suspirar por essas terras misteriosas e de aterradora beleza.',272,0.272,16.60,14.94,TRUE,3,'primeira',NULL,'978-989-676-190-5',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0027',20,14,'Protocolos de Medicina Materno-Fetal','01/01/2014','1457957759311','Nesta 3.ª edição dos Protocolos de Medicina Materno-Fetal foi feita uma cuidada revisão e atualização dos protocolos anteriormente publicados e incluídos 16 novos, respondendo aos desafios impostos pela evidência científica mais recente. Esta obra é fruto do trabalho de uma equipa de profissionais que incorpora o desejo de se manter viva a chama da vocação, a responsabilidade de dignificar a classe médica e de prestar serviço à comunidade.',296,0.296,24.95,24.95,TRUE,15,'terceira',NULL,'9789897520358',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0028',21,14,'Anatomia e Fisiologia de Seeley','01/01/2016','7037499773863','Anatomia e Fisiologia de Seeley acompanha a tendência atual do ensino integrado das ciências básicas da saúde, facilitando a aprendizagem e proporcionando uma visão multidisciplinar dos conteúdos apresentados.',1264,1.264,104.94,104.94,FALSE,6,'decima',NULL,'9788580555882',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0029',10,15,'Jorge Sampaio - Uma Biografia - 2.º volume','01/01/2017','5791462972012','Este segundo volume da biografia de Jorge Sampaio ocupa-se dos seus 16 anos como Presidente: na II Câmara Municipal de Lisboa e no Palácio de Belém.',1064,1.064,24.90,22.41,FALSE,11,'segunda',NULL,'978-972-0-04984-1',3);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0030',10,15,'Quinta-feira','01/01/2017','6142874300338','Tendo mantido até agora reservada parte importante da minha ação como Presidente da República, convicto de que essa era a melhor forma de defender o superior interesse nacional - e nunca tendo ocorrido fugas de informação para a comunicação social sobre o que se passou nos meus encontros com o Primeiro-Ministro e outros membros do Governo -, entendo que é altura de completar a prestação de contas aos Portugueses dando público testemunho de componentes relevantes da minha magistratura que são, em larga medida, desconhecidos dos cidadãos.',592,0.592,18.80,16.92,TRUE,10,'primeira',NULL,'978-972-0-04942-1',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0031',22,16,'O Amor É Contagioso','01/01/2016','1538275989525','O Amor É Contagioso é um convite a uma meditação profunda sobre os temas mais prementes da sociedade atual.',224,0.224,14.99,13.49,FALSE,8,'primeira',NULL,'9789898849434',3);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0032',23,16,'Deus ou Nada','01/01/2016','2951563092148','Nesta fascinante entrevista autobiográfica, Robert Sarah, um dos mais desassombrados cardeais da Igreja Católica, dá um testemunho ímpar da sua fé e comenta muitos dos acontecimentos, desafios e controvérsias das últimas décadas.',344,0.344,22.95,20.66,FALSE,15,'primeira',NULL,'9789898809261',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0033',24,17,'Manual de Tratamento - 250 Doenças','01/01/2016','8754155616174','Nascemos para sermos felizes, para termos conhecimento do nosso próprio corpo e estarmos saudáveis.',342,0.342,17.95,16.16,FALSE,7,'primeira',NULL,'9789899956926',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0034',25,17,'Chegar Novo a Velho - Receitas','01/01/2017','1990865252372','Depois do enorme sucesso do livro CHEGAR NOVO A VELHO, Manuel Pinto Coelho, o maior especialista português em anti-aging, apresenta um livro de receitas que seguem os princípios básicos que defende: uma alimentação promotora de hormonas, alcalina e paleolítica',176,0.176,17.50,15.75,TRUE,9,'primeira',NULL,'9789896553050',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0035',10,18,'Gosto de Matemática 1','01/01/2015','5320882212185','Gosto de Matemática é uma coleção especialmente criada para os alunos do 1.° ciclo do ensino básico praticarem o novo Programa de Matemática, alcançando as Metas Curriculares.',532,0.532,9.90,9.90,FALSE,8,'primeira',NULL,'978-972-0-14139-2',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0036',10,18,'Alfa - Adição e Subtração - 6-8 anos','01/01/2016','8004153322242','Este bloco contém exercícios para praticar a adição e a subtração que permitem: reforçar a compreensão das operações;treinar o cálculo mental;explicar e exercitar os respetivos algoritmos.',263,0.263,5.50,5.50,FALSE,15,'primeira',NULL,'978-972-0-10947-7',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0037',26,19,'Preparo-me para as Provas de Aferição - 2º Ano 2016/2017','01/01/2016','9778948328070','NA',52,0.052,7.50,6.75,TRUE,11,'primeira',NULL,'9789893201640',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0038',10,19,'Casos de Leitura - 1.º Ciclo','01/01/2017','7386725266511','Casos de Leitura é um caderno de apoio à aprendizagem da leitura e escrita, elaborado de acordo com as orientações programáticas em vigor para o 1.° Ciclo.',80,0.08,7.70,6.93,FALSE,3,'primeira',NULL,'978-972-0-17083-5',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0039',27,20,'Poemas da Mentira e da Verdade','01/01/2005','2651213145718','Livro recomendado para o 3º ano de escolaridade, destinado a leitura orientada.',34,0.034,9.51,9.51,FALSE,6,'primeira',NULL,'9789722410700',3);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0040',10,20,'A Gramática - Português - 1.º ciclo','01/01/2016','0982249097803','Esta é a gramática de referência para o 1.° Ciclo!',160,0.160,11.90,10.71,TRUE,4,'primeira',NULL,'978-972-0-11024-4',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0041',28,21,'O Beijo da Palavrinha','01/01/2008','2376391506248','Livro recomendado para o 4º ano de escolaridade, destinado a leitura autónoma.',32,0.032,12.90,12.90,TRUE,14,'primeira',NULL,'9789722120159',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0042',29,21,'Histórias do Arco da Velha','01/01/1900','0326452518593','Livro recomendado para o 4º ano de escolaridade, destinado a leitura orientada.',174,0.174,6.50,6.50,FALSE,5,'primeira',NULL,'9780009685507',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0043',28,22,'Chocolate à Chuva','15/07/2015','2676749386384','Livro recomendado para o 6º ano de escolaridade, destinado a leitura orientada.',192,0.192,11.00,11.00,FALSE,9,'primeira',NULL,'9789722100373',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0044',10,22,'Ulisses','01/01/2017','4406704142865','Livro recomendado para o 6º ano de escolaridade, destinado a leitura orientada.',80,0.080,11.90,10.71,FALSE,15,'primeira',NULL,'978-972-0-72657-5',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0045',10,23,'Gramática de Português - 3.º Ciclo','01/01/2017','8044997343834','Elaborada de raiz de acordo com o Programa e Metas Curriculares de Português do 3.° Ciclo, esta gramática é um instrumento de trabalho completo e de fácil consulta.',288,0.288,18.80,18.80,FALSE,13,'primeira',NULL,'978-972-0-30017-1',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0046',10,23,'Os Lusíadas','01/01/2015','3612976962916','A ação central da obra é a viagem de Vasco da Gama para a Índia. Dela se serve o poeta para nos oferecer a visão épica de toda a História de Portugal até à sua época, ora sendo ele o narrador, ora transferindo essa tarefa para figuras da viagem. Para outras figuras - as míticas - transfere os discursos que projetam a ação no futuro em forma profética.',288,0.288,6.60,6.60,TRUE,14,'primeira',NULL,'978-972-0-04956-8',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0047',10,24,'Preparação para o Exame Final Nacional 2017 - Português - 12.º Ano','01/01/2016','1520384702356','Este livro foi especialmente desenvolvido para os alunos dos 10.°, 11.° e 12.° anos que se encontram em fase de preparação para os Exames Finais Nacionais.',432,0.432,29.90,26.91,FALSE,3,'primeira',NULL,'978-972-0-00016-3',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0048',30,24,'Resumos - Memorial do Convento - José Saramago - Ensino Secundário','01/01/2017','6047312864156','Este estudo de Memorial do Convento pretende ajudar os alunos na sistematização dos aspetos temáticos e formais do romance saramaguiano, ao mesmo tempo que tenta promover um conhecimento mais alargado do universo de produção e divulgação da obra de José Saramago.',64,0.064,7.70,6.93,TRUE,11,'primeira',NULL,'978-972-0-40181-6',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0049',10,25,'Fichas de Ortografia - 1.º Ano','01/01/2016','2207726726159','As Fichas de Ortografia 1 são recomendadas para o 1.º ano do ensino básico e têm como principal objetivo auxiliar o aluno no estudo das regras da ortografia de forma autónoma, quer na sala de aula quer em casa.',96,0.096,7.70,6.93,FALSE,14,'primeira',NULL,'978-972-0-01810-6',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0050',10,25,'Troca-Tintas - 5-6 Anos','01/01/2017','7869210941541','A educadora da minha filha sugeriu este livro para desenvolver competências adequadas à idade da minha filha. O surpreendente neste livro é ter textos e actividades que se enquadram no Plano Nacional de Leitura que contribui para o enriquecimento do processo de aprendizagem e desenvolvimento global dos nossos filhos. Recomendo vivamente este livro, para a Educação Pré-Escolar.',79,0.079,9.90,8.91,TRUE,15,'primeira',NULL,'978-972-0-10929-3',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0051',10,26,'Apoio ao Estudo - 2.º Ano','01/01/2016','5574840389859','De acordo com o novo enquadramento legal relativo ao currículo do 1.° Ciclo do Ensino Básico, o Apoio ao Estudo é de frequência obrigatória e tem por objetivo apoiar os alunos na criação de métodos de estudo e de trabalho, visando prioritariamente o reforço do apoio nas disciplinas de Português e de Matemática.',64,0.064,8.80,7.92,TRUE,10,'primeira',NULL,'978-972-0-14104-0',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0052',10,26,'Ditados 1.º e 2.º anos','01/01/2015','7153658111035','Ditados - 1.° e 2.° anos tem como principal objetivo auxiliar o aluno a escrever corretamente e sem erros.',372,0.372,6.60,6.60,FALSE,9,'primeira',NULL,'978-972-0-14030-2',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0053',10,27,'A Matemática - 3.º e 4.º anos','01/01/2016','5480657290805','Um auxiliar essencial para o 1.º Ciclo do Ensino Básico!',160,0.160,12.20,10.98,FALSE,9,'primeira',NULL,'978-972-0-13710-4',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0054',10,27,'Fichas de Avaliação - 3.º Ano','01/01/2017','6526927280903','Português, Matemática e Estudo do Meio.',104,0.104,7.70,6.93,TRUE,5,'primeira',NULL,'978-972-0-14257-3',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0055',10,28,'Fichas de Avaliação - 4.º Ano','01/01/2016','8026294651660','Português, Matemática e Estudo do Meio;',120,0.120,7.70,7.70,FALSE,4,'primeira',NULL,'978-972-0-14258-0',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0056',10,28,'I Love English! - 9-10 anos - 4.º ano','01/01/2016','1216740100921','Aprender Inglês é cada vez mais fácil e divertido!',321,0.321,7.70,6.93,FALSE,13,'primeira',NULL,'978-972-0-18164-0',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0057',31,29,'Prova de Aferição 2017 - Matemática e Ciências Naturais - 5.º Ano','01/01/2017','8429137192716','Em 2017, vai realizar-se, pela primeira vez, a Prova de Aferição das disciplinas de Matemática e Ciências Naturais do 5.º ano. Esta publicação reúne seis propostas de provas de aferição e respetiva solução, permitindo a verificação dos conhecimentos adquiridos, bem como a superação de eventuais dificuldades, constituindo-se assim como um utensílio de estudo indispensável. Tudo o que o aluno necessita para estar 100% preparado para a Prova de Aferição.',800,0.080,7.70,6.93,TRUE,14,'primeira',NULL,'978-989-767-202-6',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0058',31,29,'Prova de Aferição 2017 - História e Geografia de Portugal - 5.º Ano','01/01/2016','7931073395202','Prova de Aferição 2017 - HGP, 5.º ano é um livro desenvolvido para auxiliar os alunos na preparação para a Prova de Aferição de História e Geografia de Portugal do 5.º ano.',80,0.080,7.70,6.93,TRUE,11,'primeira',NULL,'978-989-767-203-3',2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0059',10,30,'Preparação para a Prova Final 2017 - Matemática - 9.º Ano','01/01/2017','1697934903978','Uma das características da disciplina de Matemática, que por vezes cria grandes dificuldades aos alunos, é a forma estruturada como ela se desenvolve, tornando a falta de bases uma das principais causas e consequências de insucesso.',320,0.320,14.90,13.41,TRUE,10,'primeira',NULL,'978-972-0-00017-0',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0060',10,30,'Preparação para a Prova Final 2017 - Português - 9.º Ano','01/01/2017','0401075184361','Este livro foi especialmente desenvolvido para os alunos do 9.° ano que se encontram em fase de preparação para as Provas Finais.',256,0.256,14.90,13.41,TRUE,8,'primeira',NULL,'978-972-0-00029-3',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0061',10,31,'Preparação para o Exame Final Nacional 2017 - Física e Química A - 11.º Ano','01/01/2017','5146013439357','Com o intuito de preparar o aluno para o Exame Final Nacional de Física e Química A - 11.° ano, este livro constitui um excelente instrumento de apoio no reforço, sistematização e síntese das aprendizagens fundamentais da disciplina.',448,0.448,29.90,26.91,TRUE,3,'primeira',NULL,'978-972-0-01995-0',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0062',10,31,'Preparação para o Exame Final Nacional 2017 - Biologia e Geologia - 11.º Ano','01/01/2017','8194233259422','Com o intuito de preparar o aluno para o Exame Final Nacional de Biologia e Geologia do 11.° ano, este livro constitui um excelente instrumento de apoio no reforço, sistematização e síntese das aprendizagens fundamentais da disciplina.',304,0.304,29.90,26.91,TRUE,9,'primeira',NULL,'978-972-0-46911-3',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0063',32,35,'Autosport','22/03/2017','0985961643675','Autosport',100,0.100,2.35,2.35,TRUE,7,NULL,'Semanal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0064',33,35,'Auto Foco','23/03/2017','0109287266508','Auto Foco',100,0.100,1.99,1.99,FALSE,14,NULL,'Semanal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0065',32,36,'Take Off','23/03/2017','7049071906079','Take Off',100,0.100,1.99,1.99,FALSE,12,NULL,'Semanal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0066',33,36,'Sirius Magazine','01/02/2017','7529012336482','Sirius Magazine',100,0.100,2.50,2.50,TRUE,4,NULL,'Mensal',NULL,2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0067',33,37,'Visao','23/03/2017','4292557109070','Visao',100,0.100,3.20,3.20,TRUE,5,NULL,'Semanal',NULL,2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0068',32,37,'Sabado','23/03/2017','9918695296190','Sabado',100,0.100,3.20,3.20,FALSE,7,NULL,'Semanal',NULL,2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0069',33,61,'Caras','25/03/2017','1419098322397','Caras',100,0.100,1.50,1.50,FALSE,10,NULL,'Semanal',NULL,1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0070',33,61,'VIP','21/03/2017','0657670274761','VIP',100,0.100,1.50,1.50,FALSE,7,NULL,'Semanal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0071',33,42,'Expresso Economia','23/03/2017','2440508820339','Expresso Economia',100,0.100,1.99,1.99,FALSE,13,NULL,'Semanal',NULL,1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0072',32,42,'Vida Economica','23/03/2017','5464618601219','Vida Economica',100,0.100,1.99,1.99,TRUE,13,NULL,'Semanal',NULL,2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0073',33,40,'Dragoes','23/03/2017','7927920175420','Dragoes',100,0.100,1.50,1.50,TRUE,10,NULL,'Semanal',NULL,1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0074',32,40,'Jornal Sporting','23/03/2017','3724918280352','Jornal Sporting',100,0.100,1.50,1.50,TRUE,12,NULL,'Semanal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0075',32,47,'Exame Informatica','23/03/2017','1506012351385','Exame Informatica',100,0.100,2.50,2.50,TRUE,15,NULL,'Semanal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0076',33,47,'PC Guia','23/03/2017','0534154813213','PC Guia',100,0.100,2.50,2.50,FALSE,3,NULL,'Semanal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0077',32,62,'Teleculinaria','23/03/2017','0707129484025','Teleculinaria',100,0.100,2.50,2.50,FALSE,14,NULL,'Mensal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0078',32,62,'Ementa da semana','23/03/2017','6954574725085','Ementa da semana',100,0.100,0.50,0.50,FALSE,13,NULL,'Semanal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0079',33,39,'Caras Decoracao','23/03/2017','3209378132684','Caras Decoracao',100,0.100,3.00,3.00,TRUE,9,NULL,'Mensal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0080',33,39,'Casa Claudia','23/03/2017','9740495212784','Casa Claudia',100,0.100,3.50,3.50,FALSE,7,NULL,'Mensal',NULL,1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0081',32,51,'Evasoes','23/03/2017','4920701920776','Evasoes',100,0.100,1.60,1.60,TRUE,15,NULL,'Semanal',NULL,2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0082',32,51,'Viajar','01/03/2017','6659026698925','Viajar',100,0.100,2.00,2.00,FALSE,4,NULL,'Semanal',NULL,2);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0083',32,63,'Jornal das Letras','23/03/2017','5614434196754','Jornal das Letras',100,0.100,3.00,3.00,FALSE,11,NULL,'Semanal',NULL,1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0084',33,63,'Blitz','23/03/2017','7773017376326','Blitz',100,0.100,4.00,4.00,TRUE,15,NULL,'Mensal',NULL,1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0085',32,64,'Dica da semana','23/03/2017','6839724965936','Dica da semana',100,0.100,1.50,1.50,FALSE,7,NULL,'Semanal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0086',32,64,'Jornal de Barcelos','23/03/2017','7241848559321','Jornal de Barcelos',100,0.100,0.70,0.70,FALSE,9,NULL,'Semanal',NULL,0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0087',10,52,'Dicionário Básico Ilustrado da Língua Portuguesa','01/01/2016','2313908565730','Dicionário Básico Ilustrado da Língua Portuguesa.',512,0.512,9.99,9.99,FALSE,14,'primeira',NULL,'978-972-0-01993-6',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0088',10,53,'Dicionário Escolar de Inglês-Português / Português-Inglês','01/01/2016','7417447979942','Mais de 101 000 traduções e de 54 000 entradas, exemplos e expressões idiomáticas, incluindo os termos mais usuais do inglês americano e vocábulos brasileiros. Esta edição regista vocabulário corrente e atual, para além de várias palavras e sentidos novos das mais diversas áreas: biohazard, blogosphere, metrosexual, minicam, newbie na parte Inglês-Português e bloguista, linkar, login, porta-bebés, pró-ativo, resiliência na parte Português-Inglês.',765,0.765,9.90,8.91,TRUE,11,'primeira',NULL,'978-972-0-05422-7',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0089',10,54,'Dicionário Escolar de Francês-Português / Português-Francês','01/01/2016','5377031095792','Atualizada com o Acordo Ortográfico, esta edição regista as novas grafias, mantendo também as grafias anteriores na parte Português-Francês. Inclui igualmente um Guia do Acordo Ortográfico que expõe as principais alterações decorrentes da reforma ortográfica.',768,0.768,9.90,9.90,TRUE,7,'primeira',NULL,'978-972-0-01561-7',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0090',15,55,'Alemão em 30 Dias','01/01/2004','7335604547643','Alemão em 30 Dias é o segundo volume da colecção «Novos Manuais de Línguas». Um curso de línguas que certamente o ajudará a dar os primeiros passos na língua alemã.',324,0.324,12.50,12.50,TRUE,14,'primeira',NULL,'9789722332217',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0091',10,56,'Dicionário Moderno de Espanhol-Português / Português-Espanhol','01/01/2016','7775009678550','Um dicionário de língua espanhola, cujo texto em português se encontra adaptado ao Acordo Ortográfico de 1990. Para facilitar a pesquisa e a transição segura para a nova ortografia, na lista de entradas da parte Português-Espanhol foram registadas as duas grafias: as grafias anteriores à reforma ortográfica e as novas grafias introduzidas por ela.',1040,1.040,17.90,16.11,TRUE,7,'primeira',NULL,'978-972-0-05755-6',0);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0092',10,57,'Guias de Viagem 10 - Top 10 Marraquexe','01/01/2016','9257786970263','Este Guia de Viagem TOP 10 tem tudo o que não pode perder em Marraquexe, qualquer que seja o tipo de viagem que vai realizar. Aqui vai encontrar o que a cidade tem de melhor.',128,0.128,14.40,14.40,FALSE,9,'primeira',NULL,'978-972-0-31835-0',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0093',34,58,'Lonely Planet Costa Rica','01/01/2016','4042082573451','Lonely Planet Costa Rica is your passport to the most relevant, up-to-date advice on what to see and skip, and what hidden discoveries await you. Snorkel the teeming reefs off Manzanillo, explore some of the globes best wildlife-watching destinations, or dig into Costa Rican culture and cuisine in San Jose; all with your trusted travel companion.',544,0.544,20.98,20.98,TRUE,13,'primeira',NULL,'9781786571120',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0094',35,59,'Oriente Distante','01/01/2012','7961913135419','Viajante habitual, o autor percorre o trilho dos vestígios da cultura e presença portuguesa pelo Oriente. Neste livro, embaixador itinerante por Macau, Japão, Mongólia, Camboja, Xinjiang e Vietname onde Portugal permanece teimosamente presente - apesar da perda do protagonismo.',453,0.453,13.90,13.90,TRUE,15,'primeira',NULL,'9789895555505',1);
INSERT INTO Publicacao (PrimaveraID, editoraID,subcategoriaID,titulo,dataPublicacao,codigoBarras,descricao,paginas,peso,preco,precoPromocional,novidade,stock,edicao,periodicidade,ISBN,visitas) VALUES ('ABS0095',10,60,'CITYPACK - Londres','01/01/2017','0063535683248','Descubra a cidade de Londres com a ajuda do guia CityPack',176,0.176,13.30,11.97,TRUE,7,'primeira',NULL,'978-972-0-00039-2',0);
...
/* ------------------------------------------------------ R13 MoradaFaturacao ------------------------------------------------------ */
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (1,1);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (2,2);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (3,3);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (4,4);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (5,5);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (6,6);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (7,7);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (8,8);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (9,9);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (10,10);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (11,11);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (12,12);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (13,13);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (14,14);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (15,15);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (16,16);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (17,17);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (18,18);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (19,19);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (20,20);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (21,21);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (22,22);
INSERT INTO MoradaFaturacao (clienteID,moradaID) VALUES (23,23);

/* ------------------------------------------------------ R14 MoradaEnvio ------------------------------------------------------ */
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (1,1);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (2,2);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (3,3);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (4,4);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (5,5);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (6,6);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (7,7);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (8,8);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (9,9);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (10,10);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (11,11);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (12,12);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (13,13);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (14,14);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (15,15);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (16,16);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (17,17);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (18,18);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (19,19);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (20,20);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (21,21);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (22,22);
INSERT INTO MoradaEnvio (clienteID,moradaID) VALUES (23,23);
...
/* ------------------------------------------------------ R32 Armazem ------------------------------------------------------ */
INSERT INTO Armazem (PrimaveraArmazemID,Nome) VALUES ('ACOIM','Armazem Coimbra');
INSERT INTO Armazem (PrimaveraArmazemID,Nome) VALUES ('ALIS','Armazem Lisboa');
INSERT INTO Armazem (PrimaveraArmazemID,Nome) VALUES ('AONL','Armazem Online');
INSERT INTO Armazem (PrimaveraArmazemID,Nome) VALUES ('APOR','Armazem Porto');

/* ------------------------------------------------------ R33 ArmazemPublicacao ------------------------------------------------------ */
/* ------------------------------------------------------ Armazem Coimbra ------------------------------------------------------ */
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','1', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','2', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','3', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','4', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','5', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','6', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','7', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','8', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','9', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','10', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','11', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','12', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','13', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','14', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','15', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','16', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','17', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','18', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','19', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','20', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','21', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','22', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','23', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','24', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','25', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','26', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','27', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','28', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','29', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','30', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','31', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','32', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','33', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','34', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','35', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','36', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','37', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','38', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','39', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','40', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','41', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','42', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','43', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','44', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','45', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','46', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','47', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','48', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','49', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','50', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','51', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','52', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','53', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','54', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','55', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','56', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','57', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','58', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','59', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','60', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','61', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','62', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','63', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','64', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','65', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','66', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','67', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','68', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','69', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','70', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','71', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','72', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','73', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','74', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','75', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','76', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','77', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','78', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','79', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','80', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','81', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','82', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','83', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','84', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','85', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','86', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','87', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','88', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','89', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','90', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','91', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','92', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','93', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','94', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('1','95', 2);

/* ------------------------------------------------------ Armazem Lisboa ------------------------------------------------------ */
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','1', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','2', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','3', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','4', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','5', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','6', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','7', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','8', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','9', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','10', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','11', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','12', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','13', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','14', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','15', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','16', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','17', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','18', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','19', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','20', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','21', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','22', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','23', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','24', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','25', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','26', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','27', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','28', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','29', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','30', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','31', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','32', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','33', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','34', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','35', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','36', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','37', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','38', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','39', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','40', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','41', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','42', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','43', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','44', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','45', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','46', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','47', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','48', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','49', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','50', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','51', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','52', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','53', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','54', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','55', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','56', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','57', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','58', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','59', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','60', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','61', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','62', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','63', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','64', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','65', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','66', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','67', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','68', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','69', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','70', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','71', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','72', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','73', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','74', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','75', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','76', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','77', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','78', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','79', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','80', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','81', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','82', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','83', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','84', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','85', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','86', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','87', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','88', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','89', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','90', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','91', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','92', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','93', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','94', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('2','95', 2);

/* ------------------------------------------------------ Armazem Online ------------------------------------------------------ */
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','1', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','2', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','3', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','4', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','5', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','6', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','7', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','8', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','9', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','10', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','11', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','12', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','13', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','14', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','15', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','16', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','17', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','18', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','19', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','20', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','21', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','22', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','23', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','24', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','25', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','26', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','27', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','28', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','29', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','30', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','31', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','32', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','33', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','34', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','35', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','36', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','37', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','38', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','39', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','40', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','41', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','42', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','43', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','44', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','45', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','46', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','47', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','48', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','49', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','50', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','51', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','52', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','53', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','54', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','55', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','56', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','57', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','58', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','59', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','60', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','61', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','62', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','63', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','64', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','65', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','66', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','67', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','68', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','69', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','70', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','71', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','72', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','73', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','74', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','75', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','76', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','77', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','78', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','79', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','80', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','81', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','82', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','83', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','84', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','85', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','86', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','87', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','88', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','89', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','90', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','91', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','92', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','93', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','94', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('3','95', 2);

/* ------------------------------------------------------ Armazem Porto ------------------------------------------------------ */
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','1', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','2', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','3', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','4', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','5', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','6', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','7', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','8', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','9', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','10', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','11', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','12', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','13', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','14', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','15', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','16', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','17', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','18', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','19', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','20', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','21', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','22', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','23', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','24', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','25', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','26', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','27', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','28', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','29', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','30', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','31', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','32', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','33', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','34', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','35', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','36', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','37', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','38', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','39', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','40', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','41', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','42', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','43', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','44', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','45', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','46', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','47', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','48', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','49', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','50', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','51', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','52', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','53', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','54', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','55', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','56', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','57', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','58', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','59', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','60', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','61', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','62', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','63', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','64', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','65', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','66', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','67', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','68', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','69', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','70', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','71', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','72', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','73', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','74', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','75', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','76', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','77', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','78', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','79', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','80', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','81', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','82', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','83', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','84', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','85', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','86', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','87', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','88', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','89', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','90', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','91', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','92', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','93', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','94', 2);
INSERT INTO ArmazemPublicacao (ArmazemID,PublicacaoID,Stock) VALUES ('4','95', 2);