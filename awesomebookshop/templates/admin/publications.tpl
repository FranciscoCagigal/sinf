            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{$BASE_URL}pages/admin/publication_edit.php?id={$publication.publicacaoid}" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Editar </a>
                </td>
              </tr>
              {/foreach}
            </tbody>
...
<script src="{$BASE_URL}javascript/admin/publications_search.js"></script>
