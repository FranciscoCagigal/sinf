      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="{$BASE_URL}pages/admin/home.php" class="site_title"><i class="fa fa-book"></i> <span>Administrador</span></a>
          </div>
          ...
          <div class="profile clearfix">
            <div class="profile_pic">
              <img src="{$BASE_URL}images/admin/user.png" alt="..." class="img-circle profile_img">
            </div>
            <div class="profile_info">
              <span>Bem vindo,</span>
              <h2>{$adminData.nome}</h2>
            </div>
          </div>
          <!-- /menu profile quick info -->
